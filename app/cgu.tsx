...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    backgroundColor: COLORS.card, borderBottomWidth: 1, borderBottomColor: '#eee'
  },
  backButton: { marginRight: 15 },
  title: { fontSize: 20, fontWeight: 'bold', color: COLORS.textPrimary },
  scrollContent: { padding: 20, paddingBottom: 40 },
  intro: { fontSize: 13, color: COLORS.textSecondary, fontStyle: 'italic', marginBottom: 25 },
  section: { marginBottom: 25, backgroundColor: COLORS.card, padding: 16, borderRadius: 16, elevation: 1 },
  sectionTitle: { fontSize: 16, fontWeight: '800', color: COLORS.green, marginBottom: 8, textTransform: 'uppercase' },
  sectionText: { fontSize: 15, color: COLORS.textPrimary, lineHeight: 22, fontWeight: '500' },
  closeButton: {
    marginTop: 10, backgroundColor: COLORS.green, height: 55,
    borderRadius: 15, justifyContent: 'center', alignItems: 'center',
    elevation: 3, shadowColor: COLORS.green, shadowOffset: { width: 0, height: 4 },
